...
class ViewController: UIViewController, SideMenuViewControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        showViewController(viewController: UINavigationController.self, storyboardId: "DepartmentNavID")
    }
    ...
    func selectedCell(_ row: Int) {
        ...
        case 0:
            // Home
            self.showViewController(viewController: UINavigationController.self, storyboardId: "DepartmentNavID")
        case 1:
            // Music
            self.showViewController(viewController: UINavigationController.self, storyboardId: "EmployeeNavID")
        default:
            break
        }
