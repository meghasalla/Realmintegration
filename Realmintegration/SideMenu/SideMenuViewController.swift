...
class SideMenuViewController: UIViewController {
    ...
    var menu: [SideMenuModel] = [SideMenuModel(icon: UIImage(systemName:"book.fill")!, title: "Department"),
                                 SideMenuModel(icon: UIImage(systemName: "person.fill")!, title: "Employee")]
    ...
    override func viewDidLoad() {
        ...
        self.footerLabel.text = "Developed by Megha Salla"
